...
const STR = {
  en: {
    ...
    "hero.trust": "🔓 Open source — verify we never touch your money ↗",
    ...
    "foot.made": "made with 💸 no money", "foot.copy": "© no.money", "foot.source": "Open source ↗",
    ...
    "create.avatar_photo": "📷 Upload photo", "create.avatar_remove": "Remove photo", "toast.avatar_big": "That image won't load — try a smaller JPG or PNG.",
    "crop.title": "Position your photo", "crop.hint": "Drag to move · slider to zoom", "crop.use": "Use photo", "crop.cancel": "Cancel",
    ...
    "resume.has": "You already have a page:", "resume.share": "Share it", "resume.edit": "Edit it", "resume.new": "Start a new one",
    ...
    "modal.badge": "💸 You're officially broke", "modal.live_h3": "Your page is live. Nobody has seen it yet.",
    "modal.updated_badge": "✅ Updated", "modal.updated_h3": "Your page is updated 🎉",
    "modal.copy": "Copy link", "modal.share_label": "Post it somewhere — the image does the begging",
    "btn.copied": "Copied ✓",
    ...
    "toast.rate_limited": "You've created a lot of pages today — try again tomorrow",
    "toast.too_large": "That image is too large — pick a smaller one",
    "toast.bad_image": "That image didn't work — try another",
    ...
    "create.delete_btn": "Delete this page", "create.delete_confirm": "Tap again to delete forever",
    "create.deleting": "Deleting…",
    "create.delete_note": "Removes the page, its photo, share image and messages. Can't be undone — the handle goes back up for grabs.",
    "toast.page_deleted": "Page deleted. It's gone for good.", "toast.delete_gone": "That page is already gone",
    "toast.msg_dupe": "That message is already on the wall", "toast.msg_rate": "Slow down — too many messages today",
    ...
    "mod.gambling": "This page promotes betting or gambling tips, which No Money doesn't host. Joking about money you lost is fine — selling picks isn't.",
    "mod.scam": "This page promises profits or returns, which No Money doesn't host. Ask for support, don't offer an investment.",
    "link.nohandle": "That link goes to the site's front page, not to you — add your username or payment link after it.",
  ...
  zh: {
    ...
    "foot.made": "用 💸 no money 制作", "foot.copy": "© no.money", "foot.source": "开源 ↗",
    ...
    "create.avatar_photo": "📷 上传照片", "create.avatar_remove": "移除照片", "toast.avatar_big": "这张图加载不了——换一张小点的 JPG 或 PNG。",
    "crop.title": "调整你的头像", "crop.hint": "拖动移动 · 滑块缩放", "crop.use": "使用", "crop.cancel": "取消",
    ...
    "resume.has": "你已经有一个页面：", "resume.share": "去分享", "resume.edit": "编辑它", "resume.new": "新建一个",
    ...
    "modal.badge": "💸 你已正式破产", "modal.live_h3": "页面上线了。目前还没有人看过。",
    "modal.updated_badge": "✅ 已更新", "modal.updated_h3": "你的页面已更新 🎉",
    "modal.copy": "复制链接", "modal.share_label": "发到哪儿都行——这张图替你开口",
    "btn.copied": "已复制 ✓",
    ...
    "toast.rate_limited": "今天创建的页面有点多——明天再试",
    "toast.too_large": "图片太大了——换张小一点的",
    "toast.bad_image": "这张图片不行——换一张试试",
    ...
    "create.delete_btn": "删除这个页面", "create.delete_confirm": "再点一次，永久删除",
    "create.deleting": "删除中…",
    "create.delete_note": "会删掉页面、照片、分享图和所有留言。无法撤销——handle 也会重新开放注册。",
    "toast.page_deleted": "页面已删除，彻底没了。", "toast.delete_gone": "这个页面已经不存在了",
    "toast.msg_dupe": "这条留言墙上已经有了", "toast.msg_rate": "慢一点——今天留言太多了",
    "p.report": "举报这个页面",
    ...
    "mod.gambling": "这个页面在推销博彩/荐彩，No Money 不接受。自嘲输掉的钱完全可以——卖预测不行。",
    "mod.scam": "这个页面在承诺收益或回报，No Money 不接受。可以求打赏，但不能兜售投资。",
    "link.nohandle": "这个链接只到该网站首页，不会到你手上——后面要加上你的用户名或收款链接。",
  ...
  es: {
    ...
    "hero.trust": "🔓 Código abierto — comprueba que nunca tocamos tu dinero ↗",
    ...
    "card.broke_score": "Nivel de quiebra",
    ...
    "foot.made": "hecho con 💸 no money", "foot.copy": "© no.money", "foot.source": "Código abierto ↗",
    ...
    "create.avatar_photo": "📷 Subir foto", "create.avatar_remove": "Quitar foto", "toast.avatar_big": "Esa imagen no carga — prueba un JPG o PNG más pequeño.",
    "crop.title": "Coloca tu foto", "crop.hint": "Arrastra para mover · control para ampliar", "crop.use": "Usar foto", "crop.cancel": "Cancelar",
    ...
    "resume.has": "Ya tienes una página:", "resume.share": "Compartir", "resume.edit": "Editarla", "resume.new": "Crear una nueva",
    ...
    "modal.badge": "💸 Eres oficialmente pobre", "modal.live_h3": "Tu página está online. Todavía no la ha visto nadie.",
    "modal.updated_badge": "✅ Actualizada", "modal.updated_h3": "Tu página se ha actualizado 🎉",
    "modal.copy": "Copiar enlace", "modal.share_label": "Publícala en algún sitio — la imagen mendiga por ti",
    "btn.copied": "Copiado ✓",
    ...
    "toast.rate_limited": "Has creado muchas páginas hoy — inténtalo mañana",
    "toast.too_large": "Esa imagen es demasiado grande — elige una más pequeña",
    "toast.bad_image": "Esa imagen no funcionó — prueba con otra",
    ...
    "create.delete_btn": "Eliminar esta página", "create.delete_confirm": "Toca otra vez para borrarla",
    "create.deleting": "Eliminando…",
    "create.delete_note": "Borra la página, su foto, la imagen para compartir y los mensajes. No se puede deshacer — el handle vuelve a quedar libre.",
    "toast.page_deleted": "Página eliminada. Se fue para siempre.", "toast.delete_gone": "Esa página ya no existe",
    "toast.msg_dupe": "Ese mensaje ya está en el muro", "toast.msg_rate": "Más despacio — demasiados mensajes hoy",
    ...
    "mod.gambling": "Esta página promociona apuestas o pronósticos, y No Money no los aloja. Bromear sobre el dinero que perdiste está bien; vender pronósticos no.",
    "mod.scam": "Esta página promete ganancias o rentabilidad, y No Money no lo aloja. Pide apoyo, no ofrezcas una inversión.",
    "link.nohandle": "Ese enlace lleva a la portada del sitio, no a ti — añade tu usuario o enlace de cobro después.",
  ...
  ja: {
    ...
    "hero.trust": "🔓 オープンソース —— お金に一切触れないことをコードで確認 ↗",
    ...
    "foot.made": "💸 no money で制作", "foot.copy": "© no.money", "foot.source": "オープンソース ↗",
    ...
    "create.avatar_photo": "📷 写真をアップ", "create.avatar_remove": "写真を削除", "toast.avatar_big": "この画像は読み込めません——小さめの JPG か PNG を選んでください。",
    "crop.title": "写真の位置を調整", "crop.hint": "ドラッグで移動 · スライダーで拡大", "crop.use": "決定", "crop.cancel": "キャンセル",
    ...
    "resume.has": "すでにページがあります：", "resume.share": "シェアする", "resume.edit": "編集する", "resume.new": "新しく作る",
    ...
    "modal.badge": "💸 公式に破産しました", "modal.live_h3": "ページが公開されました。まだ誰も見ていません。",
    "modal.updated_badge": "✅ 更新済み", "modal.updated_h3": "ページを更新しました 🎉",
    "modal.copy": "リンクをコピー", "modal.share_label": "どこかに投稿しよう——画像が代わりにお願いしてくれる",
    "btn.copied": "コピー完了 ✓",
    ...
    "toast.rate_limited": "今日はたくさん作成しました——明日また試してください",
    "toast.too_large": "画像が大きすぎます——小さいものを選んでください",
    "toast.bad_image": "その画像は使えませんでした——別の画像を試してください",
    ...
    "create.delete_btn": "このページを削除", "create.delete_confirm": "もう一度タップで完全に削除",
    "create.deleting": "削除中…",
    "create.delete_note": "ページ・写真・シェア画像・メッセージをすべて削除します。取り消せません——ハンドルも再取得可能に戻ります。",
    "toast.page_deleted": "ページを削除しました。完全に消えました。", "toast.delete_gone": "そのページはもうありません",
    "toast.msg_dupe": "そのメッセージはもう掲示されています", "toast.msg_rate": "少し待って——今日は投稿が多すぎます",
    "p.report": "このページを報告",
    ...
    "mod.gambling": "このページは賭博・予想の宣伝を含んでおり、No Money では扱えません。負けた金の話は歓迎ですが、予想の販売はできません。",
    "mod.scam": "このページは利益や利回りを約束しており、No Money では扱えません。支援を求めるのは自由ですが、投資を売ることはできません。",
    "link.nohandle": "そのリンクはサイトのトップページ止まりで、あなたには届きません——後ろにユーザー名や受取リンクを付けてください。",
